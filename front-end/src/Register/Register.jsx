  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-6 bg-slate-50/40 font-sans selection:bg-blue-600 selection:text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[-10%] right-[-10%] w-[350px] md:w-[600px] h-[350px] md:h-[600px] rounded-full bg-blue-200/30 blur-3xl animate-pulse duration-[8000ms]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[350px] md:w-[600px] h-[350px] md:h-[600px] rounded-full bg-indigo-200/30 blur-3xl animate-pulse duration-[10000ms]"></div>
      </div>
        ...
        <div className="bg-white/70 backdrop-blur-2xl border border-white/50 rounded-3xl shadow-2xl p-8 md:p-10 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-slate-500 text-sm text-center -mt-1">
              Join Task Pro to start managing your daily workflows
            </p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <Link to="/user-login" className="text-blue-600 hover:text-blue-800 font-bold transition-colors">
              Log In
            </Link>
          </p>
        </div>
